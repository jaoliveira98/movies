    ...
    <div className="relative bg-gray-900 h-full">
      <div className="absolute inset-x-0 bottom-0">
        <svg
          viewBox="0 0 224 12"
          fill="currentColor"
          className="w-full -mb-1 text-amber-500"
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
          ...
          <form className="flex flex-col items-center w-full mb-4 md:flex-row md:px-16">
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center w-full h-12 px-6 font-medium text-white duration-200 rounded md:w-auto bg-amber-500"
            >
              Search
            </button>
          </form>
